...
public class AliPayUtil {
    ...
    public AliPayUtil(Activity context, Handler handler, BaseApplication application) {
    ...
    public void pay(String subject, String body, String price, String noticeUrl, final int
        ...
        Runnable payRunnable = new Runnable() {
            ...
            public void run() {
                ...
                PayModel payResult = new PayModel();
