...
import com.huotu.fanmore.pinkcatraiders.model.WXPayResult;
...
class WXPayUtilEx {
    ...
    public
    WXPayUtilEx ( Context context, Handler handler, String notifyurl, BaseApplication application
                ) {
     ...
     */
    public
    WXPayResult pay ( String body, String fee, int productType, long productid, String attach,
                      String orderId ) {
